/** The Alf Maskan logotype. The bars are the product — units going up. */
export function Mark() {
  return (
    <svg className="mark" viewBox="0 0 32 32" width={32} height={32} aria-hidden="true" focusable="false">
